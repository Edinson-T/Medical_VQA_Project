...
def plot_loss_and_acc(train_losses, val_losses, val_acc, fig_dir):
    ...
    plt.tight_layout()
    path = os.path.join(fig_dir, "0.8B_loss_and_acc.png")
...
def plot_time_bar(epoch_times, epoch_memory_MB, fig_dir):
    ...
    plt.tight_layout()
    path = os.path.join(fig_dir, "0.8B_training_time.png")
...
def plot_vram_breakdown(model_loaded_mb, train_peak_mb, fig_dir):
    ...
    plt.tight_layout()
    path = os.path.join(fig_dir, "0.8B_vram_breakdown.png")
    plt.savefig(path, dpi=150)
    plt.close()
    print(f"Saved {path.replace(os.sep, '/')}")
...
def plot_accuracy_comparison(eval_data, fig_dir):
    ...
    plt.tight_layout()
    path = os.path.join(fig_dir, "0.8B_accuracy_comparison.png")
    plt.savefig(path, dpi=150)
    plt.close()
    print(f"Saved {path.replace(os.sep, '/')}")
...
def plot_organ_comparison(eval_data, fig_dir):
    ...
    plt.tight_layout()
    path = os.path.join(fig_dir, "0.8B_organ_accuracy.png")
    plt.savefig(path, dpi=150)
    plt.close()
    print(f"Saved {path.replace(os.sep, '/')}")
...
def plot_question_type_comparison(eval_data, fig_dir, min_samples=5):
    ...
    plt.tight_layout()
    path = os.path.join(fig_dir, "0.8B_question_type_accuracy.png")
    plt.savefig(path, dpi=150)
    plt.close()
    print(f"Saved {path.replace(os.sep, '/')}")
...
def main():
    ...
    eval_path = os.path.join(result_dir, "eval_results_0.8B.json")
