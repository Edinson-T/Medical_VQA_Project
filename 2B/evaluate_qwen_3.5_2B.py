"""
evaluate_qwen3.5_2B.py

Evaluate Qwen3.5-2B zero-shot vs. fine-tuned.

Open-ended metric: Token F1 (SQuAD-style word overlap).
  - Consistent with the 2B evaluation script → results directly comparable.
...
# ============================================================================
print("=" * 60)
print("1. Zero-shot  (base Qwen3.5-2B)")
print("=" * 60)
...
output_path = os.path.join(OUTPUT_DIR, "eval_results_2B.json")
